...
export function buildReportHtml(report: FinishedGoodsReport): string {
  ...
  <table class="analysis"><colgroup><col class="no"><col class="name"><col class="standard"><col class="result"></colgroup><thead><tr class="section"><td>C.</td><td colspan="2">ORGANOLEPTIK DAN KIMIA ** :</td><td class="section-fill"></td></tr><tr><th>No.</th><th>Parameter</th><th>Standard</th><th>Hasil Analisa</th></tr></thead><tbody>${analysisRows(report)}</tbody></table>
