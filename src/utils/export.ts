...
export function buildReportHtml(report: FinishedGoodsReport): string {
  ...
  <table class="signatures"><tr><td colspan="2">Pemeriksa</td><td colspan="2">Mengetahui</td></tr><tr><td colspan="2" class="signature-name">${escapeHtml(report.inspectorName || '................................')}</td><td colspan="2" class="signature-name">${escapeHtml(report.approverName || '................................')}</td></tr><tr><td colspan="2" class="signature-line">____________________</td><td colspan="2" class="signature-line">____________________</td></tr><tr><td colspan="2" class="signature-role">QC FG Field${report.oqcType === 'OQC Monitoring' && report.analystName ? ' / ' + escapeHtml(report.analystName) : ''}</td><td colspan="2" class="signature-role">QC RM/FG Spv. / QC FG Sect. Spv.</td></tr></table>
