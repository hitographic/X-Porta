...
export function buildReportHtml(report: FinishedGoodsReport): string {
  ...
  @page{size:A4 portrait;margin:5mm}*{box-sizing:border-box}body{font-family:"Times New Roman",Times,serif;font-size:12px;line-height:1.12;margin:0;color:#000}.page-frame{border:1px solid #000;min-height:287mm}.page-content{padding:5px 12px 10px}table{width:100%;border-collapse:collapse;table-layout:fixed}td,th{border:1px solid #000;padding:1.5px 2px;vertical-align:middle;overflow-wrap:anywhere}th{font-weight:bold;text-align:center}.center{text-align:center}.bold{font-weight:bold}.meta{font-weight:bold}.document-header{border:0;border-bottom:1px solid #000}.document-header td{height:15px;border:0}.document-header .company{border-right:1px solid #000}.company{font-size:10px;text-align:center;font-weight:bold;line-height:1.25}.header-label{width:14%;font-weight:bold;padding-left:28px}.header-colon{width:3%;text-align:center}.header-value{text-align:left}.title{text-align:center;font-size:15px;font-weight:bold;margin:10px 0 2px;word-spacing:4px}.subtitle{text-align:center;font-size:12px;margin-bottom:8px}.info td{height:17px;border:0}.info .label{width:13%}.info .colon{width:3%;text-align:center}.info .value{width:30%;text-align:left;border-bottom:1px dotted #000}.info .right-label{width:15%}.info .right-colon{width:3%;text-align:center}.info .right-value{width:36%;text-align:left;border-bottom:1px dotted #000}.criteria{margin-top:8px;border:1px solid #000}.criteria col.no{width:3%}.criteria col.name{width:26%}.criteria col.standard{width:25%}.criteria col.sample{width:3.54%}.criteria th{height:17px}.criteria .number,.criteria td:first-child,.analysis td:first-child{text-align:center}.criterion-name,.standard{text-align:left;vertical-align:top}.sample{font-family:Arial,sans-serif;font-size:12px;font-weight:bold;text-align:center;padding:1px 0!important}.criteria tbody tr:not(.section) td{height:15px;border-top:1px dotted #777;border-bottom:1px dotted #777}.criteria tbody tr td:first-child,.criteria tbody tr td:nth-child(2),.criteria tbody tr td:nth-child(3){border-left:1px solid #000}.section td{background:#eee;font-weight:bold;border:1px solid #000!important;font-size:12px;vertical-align:middle}.section-fill{border:0!important}.total td{font-weight:bold;border:1px solid #000!important;background:#f5f5f5}.analysis{margin-top:8px;border:1px solid #000}.analysis col.no{width:3%}.analysis col.name{width:35%}.analysis col.standard{width:27%}.analysis col.result{width:35%}.analysis td{height:16px}.analysis-title{font-weight:bold;margin-top:10px;font-size:12px;line-height:2.4;text-align:left}.analysis-value{text-align:left}.conclusion{margin-top:10px;font-weight:bold;font-size:12px}.signatures{margin-top:12px;width:100%;border-collapse:collapse}.signatures td{padding:4px 8px;vertical-align:top;font-size:12px;border:0}.signatures .signature-name{height:52px;vertical-align:bottom;padding-bottom:1px;font-weight:bold}.signatures .signature-line{height:8px;vertical-align:top;font-weight:bold;line-height:1}.signatures .signature-role{height:16px;vertical-align:top;font-weight:normal}.footnotes{margin-top:8px;font-size:12px;color:#444;line-height:1.4}.inactive-sample{color:#ccc}.merged-sample{height:15px;background:#fff;color:#000;border:1px solid #000!important;text-align:center}
